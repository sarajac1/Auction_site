    ...
    <div className='bids_page'>
      ...
      <table className='bids_table'>
        <thead className='table_head'>
          <tr>
            <th className="bids_info bids_table_headers">Item Name</th>
            <th className="bids_info bids_table_headers">Your Bid</th>
            <th className="bids_info bids_table_headers">Highest Bid</th>
            <th className="bids_info bids_table_headers">End Time</th>
          </tr>
        </thead>
        <tbody>
          {activeBids.map(bid => (
            <tr key={bid.id}>
              <td className="bids_info bids_table_details">{bid.listingTitle}</td>
              <td className="bids_info bids_table_details">{bid.bidamount} S</td>
              <td className="bids_info bids_table_details">{bid.highestBid} S</td>
              <td className="bids_info bids_table_details">{calculateTimeLeft(bid.endDate)}</td>
            </tr>
          ))}
        </tbody>
      </table>
      ...
      <table className='bids_table'>
        <thead className='table_head'>
          <tr>
            <th className="bids_info bids_table_headers">Item Name</th>
            <th className="bids_info bids_table_headers">Winning Bid</th>
            <th className="bids_info bids_table_headers">Status</th>
            <th className="bids_info bids_table_headers">Shipment</th>
          </tr>
        </thead>
        <tbody>
          {completedBids.map((bid, index) => (
            <tr key={index}>
              <td className="bids_info bids_table_details">{bid.listingTitle}</td>
              <td className="bids_info bids_table_details">{bid.highestBid} S</td>
              <td className="bids_info bids_table_details">{bid.status}</td>
              <td className="bids_info bids_table_details">
                <button onClick={() => handleShowSellerInfo(bid.seller)}>Contact Seller</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <button><a href="/AddListing">Create listning</a></button>
    </div>
  );
};
